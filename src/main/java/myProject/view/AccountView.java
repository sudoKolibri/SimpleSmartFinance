...
public class AccountView {
    ...
    private final String currentUserId;  // Maintain the user ID
    ...
    // Constructor to inject AccountService into AccountView and initialize AccountController
    public AccountView(AccountController accountController, String currentUserId) {
        this.accountController = accountController;  // Use injected AccountController
    ...
    // Method to create a card for each account
