...
public class CategoryView {
    ...
    public CategoryView(String currentUserId, BorderPane root, CategoryController categoryController) {
    ...
    private VBox createCategoryCard(Category category) {
        ...
        card.getStyleClass().add("category-card");  // Apply the category-card CSS class
